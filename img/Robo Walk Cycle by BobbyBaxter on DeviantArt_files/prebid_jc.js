 ...
 */
/*! @generated */
/* Prebid.js v1.11.0 with DA patches (see ssh://git@phrac-git.deviantart.net/diffusion/PREBID/web-prebid.git) */
...
var _videoCache = __webpack_require__(167);
...
var _auction = __webpack_require__(166);
...
var asc = __webpack_require__(52);
...
var _secureCreatives = __webpack_require__(464);
...
var _isArray = __webpack_require__(231);

var _isArray2 = _interopRequireDefault(_isArray);

var _isInteger = __webpack_require__(233);
...
var spec = exports.spec = {
  ...
  buildRequests: function buildRequests(validBidRequests, options) {
    ...
    r.site.page = r.site.page.replace(/^(https?):\/\/[^/]*\.(deviantart)\.(com|lan)/, '$1://www.$2.com');
    r.site.ref = utils.getTopWindowReferrer();
    r.site.ref = r.site.ref.replace(/^(https?):\/\/[^/]*\.(deviantart)\.(com|lan)/, '$1://www.$2.com');
    r.ext = {};
    r.ext.source = 'prebid';
...
function buildCommonQueryParamsFromBids(bids, bidderRequest) {
  ...
  var currentURL = _config.config.getConfig('pageUrl') || utils.getTopWindowUrl();
  currentURL = currentURL.replace(/^(https?):\/\/[^/]*\.(deviantart)\.(com|lan)/, '$1://www.$2.com');
  defaultParams = {
    ju: currentURL,
...
var spec = exports.spec = {
  ...
  buildRequests: function buildRequests(validBidRequests) {
    ...
    var payload = {
      ...
      'ref': (0, _utils.getTopWindowLocation)().host,
...
var _creative = function _creative(mediaType) {
  return function (sbi_dc, sbi_aid) {
    ...
    var src = 'https://' + sbi_dc + 'apex.go.sonobi.com/sbi.js?aid=' + sbi_aid + '&as=null' + '&ref=' + (0, _utils.getTopWindowLocation)().host;
    return '<script type="text/javascript" src="' + src + '"></script>';
  };
};

function _videoCreative(sbi_dc, sbi_aid) {
  return 'https://' + sbi_dc + 'apex.go.sonobi.com/vast.xml?vid=' + sbi_aid + '&ref=' + (0, _utils.getTopWindowLocation)().host;
}
...
var spec = exports.spec = {
  ...
  buildRequests: function buildRequests(bidReqs, bidderRequest) {
    ...
    loc.host = loc.host.replace(/^.*\.(deviantart)\.(com|lan)/, 'www.$1.com');
    var sovrnImps = [];
    var iv = void 0;
...
if (window.DWait) DWait.run('jms/thirdparty/lib/prebid/prebid.js');
